...
public class AutonomousDriveDistanceDelayed extends Command {
   ...
   */
  public AutonomousDriveDistanceDelayed(DrivetrainSubsystem s_robotDrive, double distance, double speed) {
